...
# Collect User issue and create Jira ticket
def collect_issue_detail(incoming_msg):
    # Create a object to create a reply.
    response = Response()

    # Set the text of the reply.
    response.text = "I have to collect following information of your issue."
...
bot.add_command("/issue", "collect your issue and start chat", collect_issue_detail)
# bot.add_command("/live_chat", "chat with our support engineer", start_chat)
bot.add_command("attachmentActions", "*", handle_cards)
# bot.add_command("abd", "*", handle_cards)
# bot.add_command("/showcard", "show an adaptive card", show_card)
bot.add_command("/dosomething", "help for do something", do_something)
# bot.add_command(
#     "/demo_test", "Sample that creates a Teams message to be returned.", ret_message
# )
